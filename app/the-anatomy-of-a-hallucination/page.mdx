...
<div className="my-12">
<div className="flex justify-center mx-auto -mx-[calc(26vw-50%)]">
  <Image 
    src={Image5} 
    />
</div>
...
Instruction Fine-Tuning (IFT) happens after pretraining. **The goal here is to take the weights learned during pretraining and fine-tune (update) them so that the LLM can "behave" like an assistant.** This involves teaching it how to provide helpful answers in response to instructions <FootnoteRef id="2" />.
