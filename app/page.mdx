...
In 2024, I made a lot SVG animations like the one below for [Hello Interview](www.hellointerview.com), a software engineering interview prep platform. A few people have since asked me how I created those animations, so I decided to write a guide, which I've split into two parts.
