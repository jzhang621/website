    ...
    <div className="max-w-4xl mx-auto p-8">
      ...
      <div className="bg-gray-100 p-6 rounded-lg mb-8">
        ...
        <p className="text-sm text-gray-600">
          This page uses ISR with a 1-hour revalidation interval and can be invalidated on-demand
      ...
      <div className="mb-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-gray-700">
          ...
          <li>It automatically revalidates every hour when accessed</li>
      ...
      <div className="bg-blue-50 p-6 rounded-lg">
        ...
        <ol className="list-decimal list-inside space-y-2 text-gray-700">
          ...
          <li>
            ...
            <code className="bg-gray-200 px-2 py-1 rounded">POST /api/revalidate</code>
          </li>
          <li>Refresh this page to see the updated timestamp</li>
          <li>Or wait 1 hour and refresh to see automatic revalidation</li>
        </ol>
      </div>
    </div>
  );
