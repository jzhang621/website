...
My first attempts were really basic. I was dealing mainly with lengths: lengths of sentences, lengths of words, etc, which I plotted as bar charts and histograms. I didn't find these plots to be particularly interesting, and I lost interest in the project. 

But *embeddings* have me excited about this idea again!

Instead of representing text as a sequence of characters (strings), embeddings represent text as a sequence of numbers. But before we get deeper into embeddings, I want to briefly demonstrate why representations matter by looking at how computers represent color.
