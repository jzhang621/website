...
<div className="mx-auto my-8 w-96">
  <CustomImage src="/images/brighten.png" className="rounded-sm my-12" width={1574 * 1.5} height={512 * 1.5}/>
</div>
...
<div className="mx-auto my-8 w-96">
  <CustomImage src="/images/gray.png" className="rounded-sm my-12" width={1574 * 1.5} height={512 * 1.5}/>
</div>
...
Amelia Wattenberger [uses embeddings](https://wattenberger.com/thoughts/yay-embeddings-math) to measure sentences on a scale of “concrete” to “abstract”. (I *especially love* the view on the right-hand side which plots the entire essay along that scale).
